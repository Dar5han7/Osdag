...
class SvgWindow(object):
    ...
    def save_2d_image_png_names(self, view):
        ...
        if view == "Front":
            png_image_path = os.path.join(str(self.folder), "images_html", "Front.png")
            file_type = "PNG (*.png)"
            ...
            png_image_path = os.path.join(str(self.folder), "images_html", "Side.png")
            file_type = "PNG (*.png)"
            file_name, _ = QFileDialog.getSaveFileName(None, "Save File As", str(self.folder)+ "/", file_type)
            if file_name == '':
                flag = False
            ...
            png_image_path = os.path.join(str(self.folder), "images_html", "Top.png")
            file_type = "PNG (*.png)"
            file_name, _ = QFileDialog.getSaveFileName(None, "Save File As", str(self.folder) + "/", file_type)
            if file_name == '':
                flag = False
    ...
    def save_2d_image_svg_names(self, view):
        ...
        if view == "Front":
            png_image_path = os.path.join(self.folder, "images_html", "Front.svg")
            file_type = "SVG (*.svg)"
            ...
            png_image_path = os.path.join(self.folder, "images_html", "Side.svg")
            file_type = "SVG (*.svg)"
            file_name, _ = QFileDialog.getSaveFileName(None, "Save File As", self.folder + "/", file_type)
            if file_name == '':
                flag = False
            ...
            png_image_path = os.path.join(self.folder, "images_html", "Top.svg")
            file_type = "SVG (*.svg)"
            file_name, _ = QFileDialog.getSaveFileName(None, "Save File As", self.folder + "/", file_type)
            if file_name == '':
                flag = False
